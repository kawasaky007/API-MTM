...
class V1::Admin::CategoriesSerializer < ActiveModel::Serializer
  attributes Category::ADMIN_PARAMS[:SHOWABLE]
  ...
  def children
    ...
    Helpers::SerializerHelpers.each(
      object.children.map,
      each_serializer: V1::Admin::CategoriesSerializer,
  ...
  def products
    Helpers::SerializerHelpers.each(
      ...
      each_serializer: V1::Admin::ListProductsSerializer
    )
  end
